...
public class VplOrderDeliveryService extends CrudService<VplOrderDeliveryDao, VplOrderDelivery> {
	...
	@Autowired
	public VplOrderDeliveryDao vplOrderDeliveryDao;
	...
	public List<VplOrderDelivery> findAuList(VplOrderDelivery vplOrderDelivery){
		return vplOrderDeliveryDao.findAuList(vplOrderDelivery);
	}
}