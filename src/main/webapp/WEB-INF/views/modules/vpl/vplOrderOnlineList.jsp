...
<body>
	...
	<form:form id="searchForm" modelAttribute="vplOrderImport" action="${ctx}/vpl/vplOrderImport/list?remarks=online" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			<li>客户代码：<input type="text" name="cusName" value="${vplOrderImport.cusName}" style="width: 7em">&nbsp;&nbsp;&nbsp;</li>
			<li>订单编号：<input type="text" name="orderId" value="${vplOrderImport.orderId}" style="width: 7em">&nbsp;&nbsp;&nbsp;</li>
			<li>产品型号：<input type="text" name="proModel" value="${vplOrderImport.proModel}" style="width: 7em">&nbsp;&nbsp;&nbsp;</li>
			<li>下单日期：
				<input name="orderDateS" placeholder="下单日期" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					   value="<fmt:formatDate value="${orderDateS}" pattern="yyyy-MM-dd"/>"
					   onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:true});"/>
			</li>
			<li>
				<input name="orderDateE" placeholder="下单日期" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					   value="<fmt:formatDate value="${orderDateE}" pattern="yyyy-MM-dd"/>"
					   onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:true});"/>
			</li>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th style="text-align: center">铜厚UM</th>
		...
		<c:forEach items="${page.list}" var="vplOrderImport" varStatus="index">
			<tr>
				...
				<td style="text-align: center">${vplOrderImport.workType}</td>
				<td style="text-align: center">
