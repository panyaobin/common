...
<form:form id="inputForm" modelAttribute="vplOrderDelivery"  action="${ctx}/vpl/vplOrderDelivery/printView" method="post"   class="form-horizontal">
    ...
    <br>
    <div style="text-align: center;margin-bottom:20px;width: 26em;font-size: 2.5em; "><span style="">送&nbsp;&nbsp;货&nbsp;&nbsp;单</span><br>
        </div>
    <div style="width: 50.5em; font: 18px bolder;margin-bottom: 0.5em">客户名称：<input type="text" style="width: 5em;border: none;margin-right: 40em" value="${_cusName}" name="cusName">NO:<input type="text" style="width: 7.5em;border: none" value="${_cusId}"
                                                                                                                                                                                              name="deliveryId"></div>
    ...
    <table id="contentTable" class="table table-striped table-bordered table-condensed" style="width: 70em">
        ...
        <tr>
            ...
            <td style="text-align: center;margin: 0px 0px;padding: 0px 0px;width: 10em">
                ...
                <input type="text" style="width: 8em;text-align: center;display:none" value="${orderDeList[0].workType}" name="orderDeList[0].workType">
        ...
        <tr>
            ...
            <input type="text" style="width: 8em;text-align: center;display:none" value="${orderDeList[1].workType}" name="orderDeList[1].workType">
        ...
        <tr>
            ...
            <td style="text-align: center;margin: 0px 0px;padding: 0px 0px;width: 10em">
                ...
                <input type="text" style="width: 8em;text-align: center;display:none" value="${orderDeList[2].workType}" name="orderDeList[2].workType">
        ...
        <tr>
            ...
            <input type="text" style="width: 8em;text-align: center;display:none" value="${orderDeList[3].workType}" name="orderDeList[3].workType">
        ...
        <tr>
            ...
            <input type="text" style="width: 8em;text-align: center;display:none" value="${orderDeList[4].workType}" name="orderDeList[4].workType">
        ...
        <tr>
            ...
            <input type="text" style="width: 8em;text-align: center;display:none" value="${orderDeList[5].workType}" name="orderDeList[5].workType">
        ...
        <tr>
            ...
            <input type="text" style="width: 8em;text-align: center;display:none" value="${orderDeList[6].workType}" name="orderDeList[6].workType">
        ...
        <tr>
            ...
            <input type="text" style="width: 8em;text-align: center;display:none" value="${orderDeList[7].workType}" name="orderDeList[7].workType">
