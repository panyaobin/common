...
<form:form id="searchForm" modelAttribute="vplOrderDelivery" action="${ctx}/vpl/vplOrderDelivery/audited" method="post" class="breadcrumb form-search">
    ...
    <ul class="ul-form">
        ...
        <li>出货日期：
            <input name="startDateStr" id="startD"  placeholder="送货日期" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
                   value="<fmt:formatDate value="${startDateStr}" pattern="yyyy-MM-dd"/>"
            ...
            <input name="endDateStr" id="endD"  placeholder="送货日期" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
                   value="<fmt:formatDate value="${endDateStr}" pattern="yyyy-MM-dd"/>"
                   onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:true});"/>
        </li>
