    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#addTr").click(function () {
                ...
                $("#table").append("<tr style='height: 3em;'><td style='width: 1px;'><input type='text'  name='copyTr' style='text-align: center;width: 3em;margin-right: 1em' readonly  value='" + num + "'  tabindex='-1'></td><td><input type='text' name='orderImportList[" + (num - 1) + "].proModel' value='${tsyOrderImport.proModel}' style='text-align: center;width:8.5em;margin-right: 1em' class='input-small proModel'  onblur='checkRepeat(this);'></td><td><input type='number' name='orderImportList[" + (num - 1) + "].wide' value='' tabindex='' style='text-align: center;width:5em;margin-right: 1em;' class='wide'></td><td><input type='number' name='orderImportList[" + (num - 1) + "].leng' value='${tsyOrderImport.leng}' style='text-align: center;width:5em;margin-right: 1em;' class='input-small '></td><td><input type='number' name='orderImportList[" + (num - 1) + "].counts' value='${tsyOrderImport.counts}' style='text-align: center;width:5em;margin-right: 1em;' class='input-small '></td><td><select style=\"text-align: center;width:9.8em;margin-right: 1em;\" class='input-small sideType'  name='orderImportList[" + (num - 1) + "].sideType' onchange='change(this)'><option></option><c:forEach items='${sideTypeList}' var='side'><option value='${side.value}'>${side.label}</option></c:forEach></select></td><td><input type='text'  style='text-align: center;width:5.5em;margin-right: 1em;' class='input-small' name='orderImportList[" + (num - 1) + "].workType'></td><td><input type='text' name='orderImportList[" + (num - 1) + "].remarks' value='${tsyOrderImport.remarks}' style='text-align: center;width:8.5em' class='input-small '></td><td><input type='hidden' name='orderImportList[" + (num - 1) + "].price' value='' style='text-align: center;width:8.5em' class='input-small price'></td></tr>");
            });
        ...
        function validName() {
            ...
            /* debugger
             $("tr .proModel").each(function(){
                 if($(this).val()!=""){
                     alert($(this).parent().next().next().next().next().next().text());
                     if($(this).next("input .workType").val()==""){
                         alert(1);
                         return false;
                     }
                 }
    ...
    <div class="control-group" style="">
        <table style="" id="table">
            <tr style="height: 3em;text-align:center">
                ...
                <td><label class="" style="width: 7em">铜厚UM</label></td>
            ...
            <tr style="height: 3em;" class="trSum">
                ...
                <td><input type='text' name="orderImportList[0].proModel" id="proModel_1"
                           style='text-align: center;width:8.5em;margin-right: 1em' class='input-small proModel'
                           onblur="checkRepeat(this);"></td>
                <td><input type='number' name="orderImportList[0].wide" value="" tabindex=""
                ...
                <td><input type='number' name="orderImportList[0].counts" value="${tsyOrderImport.counts}"
                           style='text-align: center;width:5em;margin-right: 1em;' class='input-small '></td>
                <td><select style='text-align: center;width:9.8em;margin-right: 1em;' class='input-small sideType'
                ...
                <td>
                    <input type="text" style='text-align: center;width:5.5em;margin-right: 1em;'
                           class='input-small .workType' name="orderImportList[0].workType">
                </td>
            ...
            <tr style="height: 3em;" class="trSum">
                ...
                <td><input type='text' name="orderImportList[1].proModel" value=""
                           style='text-align: center;width:8.5em;margin-right: 1em' class='input-small proModel'
                           onblur="checkRepeat(this);"></td>
                <td><input type='number' name="orderImportList[1].wide" value="" tabindex=""
                           style='text-align: center;width:5em;margin-right: 1em;' class='wide'></td>
                <td><input type='number' name="orderImportList[1].leng" value=""
                           style='text-align: center;width:5em;margin-right: 1em;' class='input-small '></td>
                <td><input type='number' name="orderImportList[1].counts" value=""
                           style='text-align: center;width:5em;margin-right: 1em;' class='input-small '></td>
                <td><select style='text-align: center;width:9.8em;margin-right: 1em;' class='input-small'
                ...
                <td>
                    <input type="text" style='text-align: center;width:5.5em;margin-right: 1em;' class='input-small'
            ...
            <tr style="height: 3em;" class="trSum">
                ...
                <td><input type='text' name="orderImportList[2].proModel" value=""
                           style='text-align: center;width:8.5em;margin-right: 1em' class='input-small proModel'
                           onblur="checkRepeat(this);"></td>
                <td><input type='number' name="orderImportList[2].wide" value="" tabindex=""
                           style='text-align: center;width:5em;margin-right: 1em;' class='wide'></td>
            ...
            <tr style="height: 3em;" class="trSum">
                ...
                <td><input type='text' name="orderImportList[3].proModel" value=""
                           style='text-align: center;width:8.5em;margin-right: 1em' class='input-small proModel'
                           onblur="checkRepeat(this);"></td>
                <td><input type='number' name="orderImportList[3].wide" value="" tabindex=""
                           style='text-align: center;width:5em;margin-right: 1em;' class='wide'></td>
            ...
            <tr style="height: 3em;" class="trSum">
                ...
                <td><input type='text' name="orderImportList[4].proModel" value=""
                           style='text-align: center;width:8.5em;margin-right: 1em' class='input-small proModel'
                           onblur="checkRepeat(this);"></td>
                <td><input type='number' name="orderImportList[4].wide" value="" tabindex=""
                           style='text-align: center;width:5em;margin-right: 1em;' class='wide'></td>
        ...
        <div style="margin-left: 0.5em;margin-top: 1em;width: 69em">
            ...
            <input type="submit" class="btn btn-primary" id="import" value="录入" onclick="return validName();"
